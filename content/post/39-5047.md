...
### 原因、措施和规定  
  ...
  本指令的颁发是因为发现制造商将本指令表一中所列的HPT转动部件的件号从CF34发动机手册SEI-756的HPT寿命件章节中删除。我们认为这一做法意味着对该部件的寿命限制的更改，包括移除型号设计的寿命限制和强加无寿命限制。本适航指令要求对本指令表一中所列件号的HPT转动部件恢复寿命限制，防止LCF断裂以及会引起非包容性发动机失效和飞机损伤的那些部件的失效。  
完成下列工作，除非事先已完成：  
